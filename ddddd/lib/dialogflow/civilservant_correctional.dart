...
class Correctional extends StatefulWidget {

  Correctional({Key key, this.title}) : super(key: key);

  final String title;
  @override
  _CorrectionalState createState() => _CorrectionalState();
}

class _CorrectionalState extends State<Correctional> {
  ...
  void Response(query) async {
    ...
    await AuthGoogle(fileJson: "assets/jsonfile/w----hr9x-6c9d646d2cb7.json")
