...
class WebDeveloper extends StatefulWidget {
  ...
  WebDeveloper({Key key, this.title}) : super(key: key);

  final String title;
  @override
  _WebDeveloperState createState() => _WebDeveloperState();
}
...
class _WebDeveloperState extends State<WebDeveloper> {
  ...
  void Response(query) async {
    ...
    await AuthGoogle(fileJson: "assets/jsonfile/webdeveloper-hupp-239eb853d65c.json")
