...
import 'package:duruwa/widgets/firebasedemoscreen.dart';
import 'package:duruwa/screens/components/rounded_button.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:duruwa/screens/login/components/email_signup.dart';

class AirgroundPosition extends StatefulWidget {

  AirgroundPosition({Key key, this.title}) : super(key: key);

  final String title;
  @override
  _AirgroundPositionState createState() => _AirgroundPositionState();
}

class _AirgroundPositionState extends State<AirgroundPosition> {
  ...
  void Response(query) async {
    ...
    await AuthGoogle(fileJson: "assets/jsonfile/b--xarl-2641a7cda6e6.json")
